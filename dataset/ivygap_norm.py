...
def get_GAP_norm_dataloaders(batch_size=128, num_workers=8, is_instance=False):

    train_path = '/data1/GAP/Dataset_10000_5_Norm/train/'
    test_path = '/data1/GAP/Dataset_10000_5_Norm/val/'
