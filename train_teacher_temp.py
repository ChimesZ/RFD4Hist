...
from dataset.ivygap_norm import get_GAP_norm_dataloaders
...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='ivygap_5', choices=['cifar100', 'ivygap', 'ivygap_5', 'ivygap_6', 'ivygap_norm'], help='dataset')
...
def main():
    ...
    if opt.dataset == 'cifar100':
        ...
        train_loader, val_loader = get_GAP_dataloaders(batch_size=opt.batch_size, num_workers=opt.num_workers)
        n_cls = 6
    elif opt.dataset == 'ivygap_norm':
        train_loader, val_loader = get_GAP_norm_dataloaders(batch_size=opt.batch_size, num_workers=opt.num_workers)
        n_cls = 8
    else:
